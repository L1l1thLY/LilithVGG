...
def train():
    ...
    net = Judge_vgg(train_config)

    with tf.name_scope('input'):
        train_loader = data_loader.FaceDataLoader(data_config, is_train=True, is_shuffle=True)
...
# load npy
    net.load_with_skip(train_config.pre_train_weight, sess, ['fc6', 'fc7', 'fc8-2'])
